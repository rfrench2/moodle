...
$(document).ready(function() {
    ...
    $('.relatedcourseslider').each(function() {
        ...
        // Lenovo *******************************************************************************.
        // 09/20/19 - Added Added "data-label-before" to each slide.
        // Lenovo *******************************************************************************.
        var labelbefore = $(this).attr('data-label-before');         // 09/20/19
        ...
        var relatedcoursenav = '';      // 09/25/19 - Testing...

        // Lenovo *******************************************************************************.
        // 09/17/19 - Added "vertical" (True for vertical or False for horizontal).
        // Lenovo *******************************************************************************.
        ...
        if (navigationgallery == '1') {
            ...
            dots = false;
            centermode = false;
            relatedcoursenav = relatedcourseslidernav;      // 09/25/19 - Testing...
        }
        ...
        $(this).slick({
            ...
            asNavFor : relatedcoursenav,        // 09/25/19 - Testing...
            responsive: [
                {
                    breakpoint: 1024,
                    settings: {
