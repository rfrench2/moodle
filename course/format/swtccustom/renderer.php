...
class format_swtccustom_renderer extends format_section_renderer_base {
    ...
    public function __construct(moodle_page $page, $target) {
        ...
        // Since format_swtccustom_renderer::section_edit_controls() only displays the 'Set current section'
    ...
    protected function format_summary_text($section) {
        ...
        // Moved some DCG custom course format strings to /local/swtc/lang/en/local_swtc.php
        // to remove duplication of common strings.
        $headerstring1 = get_string('overview_coursetitle_line1_formatting', 'local_swtc');
        $headerstring2 = get_string('overview_coursecode_line2_formatting', 'local_swtc');
        // Removed courseversion (not implementing now).
        $headerstring4 = get_string('overview_machinetypes_line4_formatting', 'local_swtc');
        $headerstring5 = get_string('overview_duration_line5_formatting', 'local_swtc');
        $headerstring6 = get_string('overview_heading_line6_formatting', 'local_swtc');
        ...
        if ($sectionnumber === 0) {
            ...
            // Removed (or commented-out) courseversion (not implementing now).
            if (isset($debug)) {
            ...
            // Don't show course duration IF no duration is set. All courses will (eventually have a duration set).
            if ( !(empty($duration))) {
