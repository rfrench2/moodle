...
/**
 * Upgrade scripts for course format "swtcpractical"
 *
 * @package    format
...
/**
 * This method finds all courses in 'swtcpractical' format that have actual number of sections
 * bigger than their 'numsections' course format option.
 * For each such course we call {@link format_swtcpractical_upgrade_hide_extra_sections()} and
 * either delete or hide "orphaned" sections.
 */
function format_swtcpractical_upgrade_remove_numsections() {
    global $DB;
    ...
    $params = ['format1' => 'swtcpractical', 'format2' => 'swtcpractical', 'numsections' => 'numsections'];
    ...
    foreach ($needfixing as $courseid => $numsections) {
        format_swtcpractical_upgrade_hide_extra_sections($courseid, $numsections);
    }

    $DB->delete_records('course_format_options', ['format' => 'swtcpractical', 'sectionid' => 0, 'name' => 'numsections']);
}
 ...
 */
function format_swtcpractical_upgrade_hide_extra_sections($courseid, $numsections) {
    global $DB;
