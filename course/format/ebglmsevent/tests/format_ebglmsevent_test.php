...
/**
 * format_ebglmsevent related unit tests
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_ebglmsevent_testcase extends advanced_testcase {
    ...
    public function test_update_course_numsections() {
        ...
        $course = $generator->create_course(array('numsections' => 10, 'format' => 'ebglmsevent'),
    ...
    /**
     * Tests for format_ebglmsevent::get_section_name method with default section names.
     */
    public function test_get_section_name() {
        ...
        $generator = $this->getDataGenerator();
        $numsections = 5;
        $course = $generator->create_course(array('numsections' => $numsections, 'format' => 'ebglmsevent'),
            array('createsections' => true));
    ...
    /**
     * Tests for format_ebglmsevent::get_section_name method with modified section names.
     */
    ...
    /**
     * Tests for format_ebglmsevent::get_default_section_name.
     */
    public function test_get_default_section_name() {
        ...
        foreach ($coursesections as $section) {
            if ($section->section == 0) {
                $sectionname = get_string('section0name', 'format_ebglmsevent');
                $this->assertEquals($sectionname, $courseformat->get_default_section_name($section));
            } else {
                $sectionname = get_string('sectionname', 'format_ebglmsevent') . ' ' . $section->section;
                $this->assertEquals($sectionname, $courseformat->get_default_section_name($section));
            }
        }
    }
