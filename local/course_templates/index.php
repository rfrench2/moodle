...
if (!$step) {
    ...
    if (!$cid) {
        ...
        // SWTC - Get the course information from the course id.
        $course = get_course($cid);
        $header = get_string('creatingacourse', 'local_course_templates') . $course->fullname;
        echo html_writer::empty_tag('br');
        echo html_writer::tag('p', html_writer::tag('strong', $header));
        echo html_writer::empty_tag('br');
    ...
    if (!$sel_cate) {
        ...
        $categoryid = $sel_cate;
        // SWTC - echo html_writer::tag('p', html_writer::tag('strong', get_string('inputinfo', 'local_course_templates')));
        echo html_writer::tag('p', html_writer::tag('strong', get_string('inputinfo1', 'local_course_templates')));
        echo html_writer::tag('p', html_writer::tag('strong', get_string('inputinfo2', 'local_course_templates')));
