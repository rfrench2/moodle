 ...
 * History:
 *
 *	10/20/19 - Initial writing; moved majority of customized code from /lib/completionlib.php to functions defined here; added utility functions;
 *                      changed to new Lenovo EBGLMS classes and methods to load swtc_user and debug.
 * 10/21/19 - Added lenovo_report_completion.
 * 10/22/19 - Added lenovo_set_where_conditions_by_accesstype and lenovo_get_enrolled_users_by_accesstype.
 ...
 * 11/11/19 - In lenovo_report_completion, when calling lenovo_set_where_conditions_by_accesstype, added $swtc_user
 *                      as parameter to function; in lenovo_get_enrolled_users_by_accesstype, added $swtc_user as parameter to function.
 * 12/30/19 - In lenovo_report_completion, lenovo_set_where_conditions_by_accesstype and lenovo_get_enrolled_users_by_accesstype,
 *                      if $where or $whereparams was set when these functions were called, pass them along and preserve them.
 * PTR2019Q401 - @01 - 03/21/20 - In lenovo_get_enrolled_users_by_accesstype, added global flags for PS / SD management flag
 *                          (if user is manager or above) for easier access checking.
 * PTR2020Q108 - @02 - 05/11/20 - If debug is enabled, list all users including any testing users (%test%) in case cohort has not
 ...
 * 10/21/19 - Added this function.
 * 10/22/19 - Added call to lenovo_set_where_conditions_on_accesstype.
 * 11/11/19 - When calling lenovo_set_where_conditions_by_accesstype, added $swtc_user as parameter to function.
 * 12/30/19 - In lenovo_report_completion, if $where or $whereparams was set when this function was called, pass them along and preserve them.
 ...
 * 11/11/19 - In lenovo_set_where_conditions_by_accesstype, added $swtc_user to parameters to function.
 * 12/30/19 - In lenovo_set_where_conditions_by_accesstype, add $where_passed and $whereparams parameter; if $where or
 *                      $whereparams was set when this function was called, pass them along and preserve them.
 * @02 - 05/11/20 - If debug is enabled, list all users including any testing users (%test%) in case cohort has not
 *                  been populated with actual users.
 *
 */
