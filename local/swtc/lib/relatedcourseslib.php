...
/**
 * SWTC LMS for Moodle 3.7+. Functions used by related courses.
 *
 * @package    local
 * @subpackage swtc
 * @copyright  2020 SWTC
 ...
 *
 **/
function rrelatedcourses_put_courses($parentcourseid, $relatedcourses) {
 ...
 *
 **/
function rrelatedcourses_get_courses($courseid) {
