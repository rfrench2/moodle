...
class featuredcourses_form extends moodleform {
    function definition() {
        ...
        $mform->addElement('header', null, get_string('featuredcourses', 'local_swtc'));
        ...
        $mform->addElement('html', html_writer::tag('p', get_string('featuredcourses_header1', 'local_swtc')));
        $mform->addElement('html', html_writer::empty_tag('br'));
        $mform->addElement('html', html_writer::tag('p', get_string('featuredcourses_header2', 'local_swtc')));
        $mform->addElement('html', html_writer::empty_tag('br'));
        $mform->addElement('html', html_writer::tag('p', get_string('featuredcourses_header3', 'local_swtc')));
        $mform->addElement('html', html_writer::empty_tag('br'));
        $mform->addElement('html', html_writer::tag('p', get_string('featuredcourses_header4', 'local_swtc')));
        $mform->addElement('html', html_writer::empty_tag('br'));
        ...
        foreach ($sections as $section) {
            $featuredcourses = $section . 'featuredcourses';
            $mform->addElement('header', $section, get_string($featuredcourses, 'local_swtc'));
            // $mform->addElement('static', 'currentcourses', $currentcourses_string);
            $mform->addElement('html', html_writer::tag('p', get_string($section . 'featuredcourses_header', 'local_swtc')));
            $mform->addElement('select', $featuredcourses, '', $courses, $attributes);
            // $mform->setType($section . 'featuredcourses', PARAM_TEXT);

            // Lenovo ********************************************************************************.
            // Set the default to the courses that were loaded from the database.
            // Lenovo ********************************************************************************.
            foreach ($data['courses'] as $featured) {
                // print_object($featured);
                $idx = array_key_first($featured);

                if (stripos($idx, $featuredcourses) !== false) {
                    $value = $featured[$idx];
                    // print_object($value);
                    if (!empty($value)) {
                        ...
                        $element = $mform->getElement($featuredcourses);
                        ...
                        $currentcourses_string = get_string('featuredcourses_courses', 'local_swtc', array('courses' => implode(', ', $tmp)));
                        ...
                        $currentcourses_string = get_string('featuredcourses_none', 'local_swtc');
                        $mform->addElement('html', html_writer::tag('p', $currentcourses_string));
                    }
                }
            }
        ...
        // Lenovo ********************************************************************************.
        // Set the site featured courses section opened.
        // Lenovo ********************************************************************************.
    ...
    /**
     * Validate user supplied data on the featuredcourses mform.
     *
