...
require_once($CFG->dirroot.'/local/swtc/forms/dashboard_course_form.php');
...
// Lenovo *******************************************************************************
admin_externalpage_setup('dashcourse');
...
$PAGE->set_url($CFG->wwwroot.'/local/swtc/forms/dashboard_course_form.php');
...
$formdata['alltime']  = number_format(count_records_enrollments($today, "alltime"));
$formdata['lastyear']  = number_format(count_records_enrollments($today, "lastyear"));
$formdata['thisyear']  = number_format(count_records_enrollments($today, "thisyear"));

$mform = new dashboard_course_form();//name of the form you defined in file above.
