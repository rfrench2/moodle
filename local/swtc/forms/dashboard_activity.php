...
require_once($CFG->dirroot.'/local/swtc/forms/dashboard_activity_form.php');
...
// Lenovo *******************************************************************************
admin_externalpage_setup('dashactivity');
...
$PAGE->set_url($CFG->wwwroot.'/local/swtc/forms/dashboard_activity_form.php');
...
$mform = new dashboard_activity_form();//name of the form you defined in file above.
