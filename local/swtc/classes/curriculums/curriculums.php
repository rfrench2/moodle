...
/**
 * SWTC customized code for curriculums. Remember to add the
 ...
 *
 * @package    local
 * @subpackage swtc/classes/curriculums/curriculums.php
 * @copyright  2021 SWTC
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 *
 * History:
 *
 * 05/25/21 - Initial writing.
 *
 **/
namespace local_swtc\curriculums;
...
use \local_swtc\criteria\completion_completion;
...
class curriculums {
     ...
     *
     **/
    public function getall_enrollments_for_user($userid) {

        $enrolledcurriculums = array();
        $enrolledcourses = null;

        // Get ALL the curriculum courses in ALL the curriculums.
        $curriculumcourses = $this->get_all_curriculums();
     ...
     *
     **/
    public function get_all_curriculums() {
        global $DB;
     ...
     *
     **/
    public function find_course($courseid) {

        // Get ALL the curriculum courses in ALL the curriculums.
        $curriculumcourses = $this->list_courses('all');
     ...
     *
     **/
    public function list_courses($curriculum = 'all') {
        global $DB;
     ...
     *
     **/
    public function print_table($coursesprogress, $curriculumarray) {
     ...
     *
     **/
    public function getcompletionstatus_details($id, $userid) {
        ...
        if (empty($completions)) {
            ...
            $output .= html_writer::tag('th', get_string('criteria', 'completion'),
                array('class' => 'c1 header', 'scope' => 'col'));
     ...
     *
     **/
    public function report_completion_index($swtcuser, $courseid) {
        ...
        */
        ...
        if (!$csv) {
            ...
            if (!$total) {
                // Fixed table output if no users are listed.
                // No OUTPUT here (put in calling function).
                // And change "exit" to "return".
                return;
            }
