 ...
 * 03/03/21 - Changed class name from swtc_sebug to SwtcDebug.
 *
 **/
...
class SwtcDebug {
    ...
    public function __construct() {
        ...
        // print_object("In SwtcDebug __construct");		// 10/18/20 - SWTC
        // print_object("In SwtcDebug __construct; about to print backtrace");		// 10/16/20 - SWTC
