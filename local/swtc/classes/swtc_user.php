...
class swtc_user {
	...
	function set_user_role($eventdata) {
		...
		$user_related = null;
		/** @var $tmp_user Hold return values from /local/swtc/classes/swtc_user.php get_user_access. */
		$tmp_user = new swtc_user();
		// SWTC ********************************************************************************
	...
	function get_user_access() {
		...
		$temp_user = clone $this;      // Create a swtc_user object.
		...
		if (isset($debug)) {
			...
			// $messages[] = "Entering /local/swtc/classes/swtc_user.php. ===3.get_user_access.enter.";
			$messages[] = "SWTC ********************************************************************************.";
			// $phplog = debug_enable_phplog($debug, "In /local/swtc/classes/swtc_user.php. ===3.get_user_access.enter.');
			$debug->logmessage($messages, 'both');
			unset($messages);
		}
