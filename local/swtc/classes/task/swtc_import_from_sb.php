 ...
 * Version details
 *
 * @package    swtc_import_from_sb (keep synchronized with swtc_pre_import_from_sb).
...
// DCG run ThinkSystem import from SB task.
class swtc_import_from_sb extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('crontaskimport', 'local_swtc');
    }
    ...
    public function execute() {
        ...
        $options = array(
            ...
            'preview' => false,                             // Actually import from the ServiceBench production server.
            'sbserver' => 'prod',                           // Actually import from the ServiceBench production server.
            'force' => false,
            'date' => false,
            'email' => false,
            'help' => false
