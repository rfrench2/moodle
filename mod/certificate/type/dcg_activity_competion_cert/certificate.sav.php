...
// certificate_print_text($pdf, $x, $y + 205, 'C', 'Helvetica', '', 20, format_string($course->fullname)); // Lenovo
certificate_print_text($pdf, $x, $y + 205, 'C', 'Helvetica', '', 20, format_string($coursename));	// Lenovo
