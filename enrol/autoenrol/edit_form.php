 ...
 * Lenovo history:
 *
 * 08/20/19 - In add_general_section, removed several settings from "Advanced" as they were hard to remember they were there.
 * 10/08/19 - Added this header.
 *
 */
...
class enrol_autoenrol_edit_form extends moodleform {
    ...
    protected function add_general_section($instance, $plugin, $context) {
        ...
        // $this->_form->setAdvanced('customint3');     // 08/20/19 Lenovo
        ...
        // $this->_form->setAdvanced('customint1');     // 08/20/19 Lenovo
        ...
        // $this->_form->setAdvanced('customint8');     // 08/20/19 Lenovo
        ...
        // $this->_form->setAdvanced('customint6');     // 08/20/19 Lenovo
